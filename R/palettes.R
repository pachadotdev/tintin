...
tintin_clrs <- function(n = 5, alpha = 1, begin = 0, end = 1, direction = 1, option = "the_blue_lotus") {
  ...
  use_clrs <- switch(
    EXPR = option,
    tintin_in_the_land_of_the_soviets = c(tintin::tintin_colours[["tintin_in_the_land_of_the_soviets"]], "#ffffff"),
    tintin_in_the_congo = c(tintin::tintin_colours[["tintin_in_the_congo"]], "#ffffff"),
    tintin_in_america = c(tintin::tintin_colours[["tintin_in_america"]], "#ffffff"),
    cigars_of_the_pharaoh = c(tintin::tintin_colours[["cigars_of_the_pharaoh"]], "#ffffff"),
    the_blue_lotus = c(tintin::tintin_colours[["the_blue_lotus"]], "#ffffff"),
    the_broken_ear = c(tintin::tintin_colours[["the_broken_ear"]], "#ffffff"),
    the_black_island = c(tintin::tintin_colours[["the_black_island"]], "#ffffff"),
    king_ottokars_sceptre = c(tintin::tintin_colours[["king_ottokars_sceptre"]], "#ffffff"),
    the_crab_with_the_golden_claws = c(tintin::tintin_colours[["the_crab_with_the_golden_claws"]], "#ffffff"),
    the_shooting_star = c(tintin::tintin_colours[["the_shooting_star"]], "#ffffff"),
    the_secret_of_the_unicorn = c(tintin::tintin_colours[["the_secret_of_the_unicorn"]], "#ffffff"),
    red_rackhams_treasure = c(tintin::tintin_colours[["red_rackhams_treasure"]], "#ffffff"),
    the_seven_crystal_balls = c(tintin::tintin_colours[["the_seven_crystal_balls"]], "#ffffff"),
    prisoners_of_the_sun = c(tintin::tintin_colours[["prisoners_of_the_sun"]], "#ffffff"),
    land_of_black_gold = c(tintin::tintin_colours[["land_of_black_gold"]], "#ffffff"),
    destination_moon = c(tintin::tintin_colours[["destination_moon"]], "#ffffff"),
    explorers_on_the_moon = c(tintin::tintin_colours[["explorers_on_the_moon"]], "#ffffff"),
    the_calculus_affair = c(tintin::tintin_colours[["the_calculus_affair"]], "#ffffff"),
    the_red_sea_sharks = c(tintin::tintin_colours[["the_red_sea_sharks"]], "#ffffff"),
    tintin_in_tibet = c(tintin::tintin_colours[["tintin_in_tibet"]], "#ffffff"),
    the_castafiore_emerald = c(tintin::tintin_colours[["the_castafiore_emerald"]], "#ffffff"),
    flight_714_to_sydney = c(tintin::tintin_colours[["flight_714_to_sydney"]], "#ffffff"),
    tintin_and_the_picaros = c(tintin::tintin_colours[["tintin_and_the_picaros"]], "#ffffff"),
    tintin_and_alph_art = c(tintin::tintin_colours[["tintin_and_alph_art"]], "#ffffff")
  )
