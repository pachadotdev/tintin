...
ggplot(total_head_trauma_10) +
  ...
  labs(x = "Cause of injury", y = "Loss of consciousness length",
    title = "Top ten causes of injury") +
  scale_fill_manual(values = tintin_pal(option = "the_castafiore_emerald")(8), 
    name = "Book") +
  coord_flip()
```
...
d + 
  scale_colour_tintin_c(option = "tintin_in_the_land_of_the_soviets") + 
  theme_bw()
```
